  ...
  return (
    <footer className="max-w-screen-2xl px-4 md:px-8 mx-auto">
        ...
        <div className="flex gap-4">
            ...
            <a href="https://github.com/NUTFes/stickee_lottery" target="_blank" className="text-gray-400 hover:text-gray-500 active:text-gray-600 transition duration-100">
            <svg className="w-5 h-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="text-gray-400 text-sm text-center py-8">© 2022 - Present NUTMEG. All rights reserved.</div>
    </footer>
  );
};
