...
const Header = (props: HeaderProps) => {
  return (
      <header className="flex justify-between items-center py-4 md:py-8">
        ...
        <a href="/admin" className="inline-flex items-center text-black-800 text-2xl md:text-3xl font-bold gap-2.5" aria-label="logo">
            学籍番号抽選会
        </a>


        <nav className="hidden lg:flex gap-12">
            <a href="/admin" className="text-gray-600 hover:text-indigo-500 active:text-indigo-700 text-lg font-semibold transition duration-100">Home</a>
