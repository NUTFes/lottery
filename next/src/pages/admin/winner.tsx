                ...
                <div className="flex flex-wrap gap-4 lg:gap-6 sm:py-2.5">
                  ...
                  <div className="flex flex-col justify-between flex-1">
                    <div>
                      ...
                      <span className="block text-gray-500">当選番号: {winner.id}</span>
                    </div>
                  </div>

                  <div className="flex flex-col justify-between flex-1">
                    <div>
                      <span className="block text-gray-500">登録日時: {winner.created_at}</span>
                      <span className="block text-gray-500">更新日時: {winner.updated_at}</span>
                    </div>
                  </div>
